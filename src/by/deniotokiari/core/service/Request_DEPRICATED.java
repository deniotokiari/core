...
public class Request_DEPRICATED<Query, Source, Result> {
    ...
    public Request_DEPRICATED(Intent intent) {
     ...
     * @param isNeedCache
     */
    public Request_DEPRICATED(Source source, String processorKey, boolean isNeedCache) {
        setArgsToBundle(source, null, processorKey, isNeedCache, true);
    }

    public Request_DEPRICATED(Query query, String sourceKey, String processorKey,
                              boolean isNeedCache) {
