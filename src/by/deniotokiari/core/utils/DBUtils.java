...
import by.deniotokiari.core.annotations.db.types.DBBoolean;
...
public class DBUtils {
	...
	private static final String TEMPALTE_UNIQUE = "UNIQUE (%s)";
	...
	private static String getUniqueFileds(List<Field> fields) {
